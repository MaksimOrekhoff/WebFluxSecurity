        ...
        return userService.getUserByUsername(username)
                .flatMap(user -> {
                    ...
                    if (!passwordEncoder.matches(password, user.getPassword())) {
                        return Mono.error(new AuthenticationException("Invalid password", "OREKHOFF_INVALID_PASSWORD"));
                    }
                ...
                .switchIfEmpty(Mono.error(new AuthenticationException("Invalid username", "OREKHOFF_INVALID_USERNAME")));
    }
}
